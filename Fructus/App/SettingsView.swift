            ...
            ScrollView(.vertical, showsIndicators: false){
                VStack(spacing: 20) {
                    ...
                    )
                    {
                        ...
                        HStack(alignment: .center, spacing: 10) {
                            Image("logo")
                                ...
                                .cornerRadius(9)
                            Text("Most fruits are naturally low in fat, sodium, and calories. None have cholesterol. Fruits are sources of many essential nutrients, inluding potassium, dietary fiber, vitamins, and much more.")
                                .font(.footnote)
                        }
                    }
                    ...
                    )
                    {
                        ...
                        SettingsRowView(name: "Twitter", linkLabel: "@Mixorok", linkDestination: "twitter.com/Mixorok")
